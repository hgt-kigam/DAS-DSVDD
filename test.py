import torch
import easydict
from model import Deep_SVDD_96_100
...
dataloader_test = make_dataloader(data_dir='../tdms2img/image_96_clip', args=args, shuffle=False)
...
net = Deep_SVDD_96_100(args).to(device)
